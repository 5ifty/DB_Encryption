...
class SpreadsheetConverter():
    def __init__(self) -> None:
        self.Path = r'C:\Users\oem\Documents\DB_Encryption\output\convertedData.json'
        pass
...
# in converting the xlsx file into a readable json format which will then be processed into the DB
    def converter(self):
        xlsx2Csv = pandas.read_excel(r'C:\Users\oem\Documents\DB_Encryption\input\spreadsheetData.xlsx')
 
        xlsx2Csv.to_csv(r'C:\Users\oem\Documents\DB_Encryption\output\CSVData.csv', index=None, header=True)
        csvPath = r'C:\Users\oem\Documents\DB_Encryption\output\CSVData.csv'
        jsonPath = r'C:\Users\oem\Documents\DB_Encryption\output\convertedData.json'

        if os.path.exists(r'C:\Users\oem\Documents\DB_Encryption\output\CSVData.csv') == True:
            pass
        try:
            readCSV = pandas.DataFrame(pandas.read_csv(r'C:\Users\oem\Documents\DB_Encryption\output\CSVData.csv)'))
        except OSError as e:
            pass
